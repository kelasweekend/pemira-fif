                                        ...
                                        <tbody>
                                            @foreach ($calon as $item)
                                                <tr>
                                                    ...
                                                    <th>{{ $item->nama_ketua }}</th>
                                                    <th>{{ $item->nama_wakil }}</th>
                                                    <th>{{ $item->jurusan }}</th>
                                                    <th>
                                                        <div class="d-flex">
                                                            <a href="{{ route('pemira.edit', $item->id) }}"
                                                                class="btn btn-warning btn-sm mr-2"><i
                                                                    class="fas fa-edit"></i></a>
                                                            <a href="javascript:void(0)" data-toggle="tooltip"  data-id=" {{$item->id}} " data-url=" {{route('pemira.destroy', $item->id)}} " data-original-title="Delete" class="btn btn-danger btn-sm deleteItem"><i class="fas fa-trash"></i></a>
                                                        </div>
                                                    </th>
                                                </tr>
                                            @endforeach
