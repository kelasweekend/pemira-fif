...
<nav class="mt-2">
    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        @can('menu-user')
            ...
            <li class="nav-item {{ Request::segment(1) === 'admin' ? 'menu-is-opening menu-open': null }}">
                <a href="#" class="nav-link {{ Request::segment(2) === 'admin' ? 'active' : null }}">
                    <i class="nav-icon fas fa-clipboard-list"></i>
                    <p>
                        Pemira System
                        <i class="right fas fa-angle-left"></i>
                ...
                <ul class="nav nav-treeview">
                    <li class="nav-item">
                        <a href="{{route('pemira.index')}}" class="nav-link {{ Request::is('admin/pemira') ? 'active' : '' }}">
                            <i class="far fa-circle nav-icon"></i>
                            <p>Setting Calon</p>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="{{route('pemilih.index')}}" class="nav-link {{ Request::is('admin/pemilih') ? 'active' : null }}">
                            <i class="far fa-circle nav-icon"></i>
                            <p>Setting Pemilih</p>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="{{route('hasil')}}" class="nav-link {{ Request::is('admin/vote') ? 'active' : null }}">
                            <i class="far fa-circle nav-icon"></i>
                            <p>Vote Management</p>
                        </a>
                    </li>
